...
import unibuc.carServiceManagement.domain.*;
...
import unibuc.carServiceManagement.mapper.AppointmentMapper;
...
public class AppointmentServiceTest {
    ...
    private CarService carService = new CarService("Name", "Address");
    private Mechanic mechanic = new Mechanic("John", "Smith", Speciality.SUSPENSION, carService);
